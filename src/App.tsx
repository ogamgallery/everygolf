      ...
      if (!isLoggedIn) {
        return (
          <div className="pb-32 bg-white min-h-full flex flex-col w-full overflow-hidden">
            ...
            {/* 웰컴 / 로그인 권유 배너 */}
            <div className="flex-1 flex flex-col justify-center items-center px-6 py-12 text-center my-auto">
              <div className="w-16 h-16 rounded-full bg-green-50 flex items-center justify-center text-green-600 mb-5 shadow-sm">
                <User size={32} />
              </div>
              <h3 className="text-lg font-black text-gray-900 leading-snug">로그인하고 에브리골프를 시작해 보세요</h3>
              <p className="text-xs text-gray-400 font-bold mt-2 leading-relaxed">
                로그인하시면 맞춤형 조인 매칭 서비스와<br />
                보유 응모볼 관리 및 다양한 혜택을 이용하실 수 있습니다.
              </p>

              <button 
                onClick={() => pushView('login')}
                className="w-full max-w-[280px] py-4 mt-8 bg-green-600 hover:bg-green-700 active:scale-[0.98] text-white font-black rounded-xl text-sm shadow-md shadow-green-100 transition-all"
              >
                로그인 / 회원가입
              </button>
            </div>

            <div className="p-8 shrink-0 text-center flex flex-col items-center w-full border-t border-gray-50">
